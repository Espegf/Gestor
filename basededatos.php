		...
		<div id="content">
			...
			<div class="container container-content">
				...
				<aside class="col-md-3 col-xs-12 no_left">
					...
					<div class="bloc ">
						<h3 class="grey">Bases de datos</h3>
...
<form action="">
<input type="button" onclick = "this.form.action = 'formcrearbd.php'; this.form.submit()"  VALUE="Crear bases de datos" class="estilo2"/>
<input type="button" onclick = "this.form.action = 'formborrarbd.php'; this.form.submit()" VALUE="Borrar bases de datos" class="estilo2"/>
...
echo "<table border = '1'> \n"; 
echo "<tr><td>Base de datos existentes en el sistema:</td></tr> \n"; 
