		...
		<div id="content">
			...
			<div class="container container-content">
				...
				<aside class="col-md-3 col-xs-12 no_left">
					...
					<div class="bloc ">
						<h3 class="grey">Creación de usuarios</h3>
...
<br>
              ...
              <br>
   <center>           
    <input style="background-color: #4EB24D" type="submit" value="Borrar" />
    <input style="background-color: #4EB24D" type="reset" value="Restablecer" />  
    <input style="background-color: #4EB24D" type="button" onclick = "this.form.action = 'index.htm'; this.form.submit()" VALUE="Volver" />
