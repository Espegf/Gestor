		...
		<div id="content">
			...
			<div class="container container-content">
				...
				<aside class="col-md-3 col-xs-12 no_left">
					...
					<div class="bloc ">
						<h3 class="grey">Usuarios</h3>
						<span class="date green">20-1-2021</span>
						<p class="grey">Elige lo que desees hacer. </p>
						</div>
<form action="">
    <center>
<input style="background-color: #4EB24D" class="estiloboton" height="100px" width="230px" type="button" onclick = "this.form.action = 'formregistro.php'; this.form.submit()"  VALUE="Crear usuarios" class="estilo2"/>
<input style="background-color: #4EB24D" type="button" onclick = "this.form.action = 'formborrar.php'; this.form.submit()" VALUE="Borrar usuarios" class="estilo2"/>
<br>
