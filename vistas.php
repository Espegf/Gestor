		...
		<div id="content">
			...
			<div class="container container-content">
				...
				<aside class="col-md-3 col-xs-12 no_left">
					...
					<div class="bloc ">
						<h3 class="grey">Vistas</h3>
						<span class="date green">20-1-2021</span>
						<p class="grey">Elige lo que desees hacer. </p>
	<center>
        <head >
    <h1 class="estilo0"> Programa diseñado para vistas </h1>
</head>

<form action="">
<input type="button" onclick = "this.form.action = 'regvervistas.php'; this.form.submit()"  VALUE="Ver vistas" class="estilo2"/>
<input type="button" onclick = "this.form.action = 'regborrarvistas.php'; this.form.submit()" VALUE="Borrar vistas" class="estilo2"/>
<br>
<br>
<br>
<?php
...
echo "<table border = '1'> \n"; 
echo "<tr><td>Vistas creadas</td></tr> \n"; 
